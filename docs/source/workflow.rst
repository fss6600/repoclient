...
**Путь к репозиторию** [*]_
    ...
    Для настройки репозиториев нажмите |определение репозиториев| справа от поля с адресом репозитория. В окне перечня репозиториев вы можете создать |добавить репозиторий|,
    изменить |редактировать репозиторий| или удалить |удалить репозиторий| репозитории. По завершению нажмите |применить|, чтобы применить изменения или |отменить|, чтобы вернуть список .

.. figure:: _static/images/settings_list.png
    :align: center
...
.. |определение репозиториев| image:: _static/images/settings_list_button.png

.. |добавить репозиторий| image:: _static/images/settings_list_add.png

.. |редактировать репозиторий| image:: _static/images/settings_list_edit.png

.. |удалить репозиторий| image:: _static/images/settings_list_delete.png

.. |применить| image:: _static/images/settings_list_apply.png

.. |отменить| image:: _static/images/settings_list_undo.png
